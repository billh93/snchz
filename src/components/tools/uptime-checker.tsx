          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-golden/90 px-4 py-2.5 text-sm font-medium text-background transition-colors hover:bg-golden disabled:opacity-50"
              >
                {isChecking ? (
              ...
              <button
                ...
                className={cn(
                  ...
                  isRunningBatch
                    ...
                    : "border-border/50 bg-surface/30 text-foreground hover:border-golden/30 hover:text-golden disabled:opacity-50"
                )}
              >
                {isRunningBatch ? (
                  <>
